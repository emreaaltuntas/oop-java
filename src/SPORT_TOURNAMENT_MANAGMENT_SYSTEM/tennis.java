...
class tennis extends APlayerData {
    private String name;
    ...
    public tennis(String name, String gender, double height, double weight, int age) {
        this.name = name;
        this.gender = gender;
        this.height = height;
        this.weight = weight;
    ...
    @Override
    void complete() {
        System.out.println("The player has been enrolled for tennis.");
    }
